"""
Historical Data Backfill with Checkpointing

This script retrieves historical AQI and meteorological data with:

- Checkpointing to resume interrupted runs
- Progress tracking for data collection status
- Rate limiting to comply with API usage constraints
- Local storage of raw data prior to feature processing

DATA REQUIREMENTS
══════════════════════════════════════════════════════════════

- Historical coverage: 1 year of hourly observations for training
- Features: Weather and pollutant measurements merged by timestamp
- Target: AQI forecasting up to 72 hours ahead

API USAGE CONSTRAINTS
══════════════════════════════════════════════════════════════

- Weather API: 1000 calls per day
- Air quality API: High-volume historical access with valid credentials

BACKFILL STRATEGY
══════════════════════════════════════════════════════════════

- Retrieve data in ~30-day batches
- Approximately 365 weather API calls required per city for 1 year
- Full historical coverage per city typically completed within 1–2 days
"""
